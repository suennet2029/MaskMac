...
4. **Aura**：自动感知本地运行的 **Claude Code**、**CodeX** 与 **antiGravity**，驱动屏幕顶部 **激光霓虹跑马灯** 与 MacBook **物理键盘背光柔和呼吸**，任务完成后平滑淡出并自动熄灭（零按键冲突，打字无忧）。
...
* 🌈 **AI 任务炫彩流光指示 (Aura)**：启动 Claude Code、CodeX 或 antiGravity 后，屏幕顶部自动浮现高科技霓虹激光跑马灯，键盘背光同步呼吸；任务完成瞬间丝滑淡出消失，既清晰可见又绝不干扰正常打字输入。
...
| **Aura** | — | 开关 AI 任务指示（顶部激光跑马灯 + 键盘背光呼吸） |
