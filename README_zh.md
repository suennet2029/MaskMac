...
4. **Aura**：自动感知本地运行的 **Claude Code**、**CodeX** 与 **antiGravity**，在全屏幕四周边框呈现媲美 **Apple Intelligence** 的全景呼吸流光跑马灯（多层霓虹弥散光晕 + 核心激光条有机微微闪烁），并同步联动物理键盘背光柔和呼吸，任务完成后平滑淡出并自动熄灭（零按键冲突，打字无忧）。
...
* 🌈 **Apple Intelligence 风格全屏跑马灯 (Aura)**：启动 Claude Code、CodeX 或 antiGravity 任务生成时，全屏幕边框自动泛起灵动流光与柔和微闪呼吸；任务完成瞬间丝滑淡出消失，既清晰可见又绝不干扰正常打字输入。
...
| **Aura** | — | 开关 AI 任务指示（全屏 Apple Intelligence 流光微微闪烁 + 键盘背光呼吸） |
