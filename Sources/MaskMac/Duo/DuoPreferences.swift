...
@MainActor
final class DuoPreferences: ObservableObject {
    static let shared = DuoPreferences()

    private enum Key {
        static let isEnabled = "duoIsEnabled"
        static let isTimeoutEnabled = "duoIsTimeoutEnabled"
        static let thresholdAngle = "duoThresholdAngle"
        static let blurSpan = "duoBlurSpan"
        static let maxBlurRadius = "duoMaxBlurRadius"
        static let maxDim = "duoMaxDim"
        static let viewingDistance = "duoViewingDistance"
        static let recession = "duoRecession"
        static let blurEvenness = "duoBlurEvenness"
        static let dimReach = "duoDimReach"
        static let showsAngleInMenuBar = "duoShowsAngleInMenuBar"
        static let isLivePicture = "duoIsLivePicture"
